...
> This article is source from my open source book [[Istio Insider]](https://envoy-insider.mygraphql.com/en/latest/dev-istio/dev-istio-proxy/debug-istio-proxy/debug-istio-proxy.html).
...
For me, Deep dive into the behavior of sidecar (istio-proxy) in Istio service mesh make me more confidence to finish my book: [Istio Insider](http://envoy-insider.mygraphql.com/). I want to use (`lldb`/`gdb`) + `VSCode` to debug  `Envoy`(C++ code) which running on an Istio service mesh. 
...
:::
*[Open with Draw.io](https://app.diagrams.net/?ui=sketch#Uhttps%3A%2F%2Fenvoy-insider.mygraphql.com%2Fzh_CN%2Flatest%2F_images%2Fremote-lldb-istio-proxy.drawio.svg)*
...
:::{figure-md} Figure: Remote lldb debug istio-proxy 2
:class: full-width

<img src="/dev-istio/dev-istio-proxy/debug-istio-proxy/remote-lldb-istio-proxy.drawio.svg" alt="Figure - Remote lldb debug istio-proxy 2">
